...
variables = [y_pred_mlr, y_pred_rand, y_pred_nn] #add neural network
labels = ["Linear Regression", "Straight-Line", "Neural Network"] # add neural network
